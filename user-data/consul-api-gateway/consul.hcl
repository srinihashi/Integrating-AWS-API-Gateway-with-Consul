...
##encrypt = "xyxl8rxwBU8KQgxYKH8rZrtccaji2N0LcNTn4vIjg78="

# Enable the ACL system
##acl {
##  enabled = true                       # Enables ACLs
##  default_policy = "deny"              # Deny access by default (secure setting)
##  enable_token_persistence = true      # Allows token persistence across restarts
##  tokens {
##    initial_management = "ff7938a8-890a-2b2b-85cb-bca52c16e0a0"   # Initial management token. Create with: openssl rand -hex 16 | sed -E 's/(.{8})(.{4})(.{4})(.{4})(.{12})/\1-\2-\3-\4-\5/'
##  }
##}
...
##tls {
##  defaults {
##    ca_file = "/etc/consul.d/certs/ca-cert.pem"
##    cert_file = "/etc/consul.d/certs/consul-server-cert.pem"
##    key_file = "/etc/consul.d/certs/consul-server-key.pem"
##  }
##}
##verify_incoming = true              # Verify incoming connections
##verify_outgoing = true              # Verify outgoing connections
##verify_server_hostname = true       # Verify the server hostname
...
#retry_join = ["172.31.45.114","172.31.45.110","172.31.41.195"]
#retry_join = ["54.198.10.103","98.83.158.252","34.228.241.35"]
#retry_join = ["[::1]:8301"]
...
retry_join = ["provider=aws tag_key=auto-join tag_value=yes"]
#retry_join = ["provider=azure tag_name=... tag_value=... tenant_id=... client_id=... subscription_id=... secret_access_key=..."]
#retry_join = ["provider=gce project_name=... tag_value=..."]

# WAN join
#retry_join_wan = ["172.31.36.18","172.31.42.252","172.31.38.186","172.31.45.114","172.31.45.110","172.31.41.195"]
